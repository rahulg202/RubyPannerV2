...
def build_services() -> tuple[OptimizerService, OnboardingService, ComparisonService]:
...
def main() -> None:
    ...
    optimizer_service, onboarding_service, comparison_service = build_services()
    ...
    tab_set, tab_opt, tab_ob, tab_cmp = st.tabs(
        ["Settings", "Cost Optimizer", "Onboarding", "Comparison"]
    )
